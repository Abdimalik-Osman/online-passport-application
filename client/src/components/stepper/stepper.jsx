...
const Stepper = ({ steps }) => {
  ...
  <HorizontalStepper />
   {steps[activeStep]}
   <div style={{ marginLeft: activeStep === 0 ? "400px" : "200px" }}>
  {activeStep && <button
    type="button"
  ...
  <button
    ...
    className="w-full sm:w-auto rounded-md bg-indigo-600 w-25 py-2 text-sm font-semibold text-white shadow-sm hover:bg-indigo-500 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-indigo-600">
    NEXT
  </button>
  </div>
</div>
